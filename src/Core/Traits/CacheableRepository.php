...
trait CacheableRepository
{
     ...
     *
     * @param  \Repository\Contracts\CriteriaInterface $criterion
     * @throws \Exception
     * @return \Repository\Contracts\CriteriaInterface|array
     *
     */
    ...
    {
        $cacheSeconds = isset($this->cacheMinutes) ? $this->cacheMinutes : config('repository.cache.minutes', 30);
