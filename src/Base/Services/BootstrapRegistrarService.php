...
use Base\Contracts\Abstracts\Policy;
use Base\Contracts\ConditionalAutoRegistration;
...
class BootstrapRegistrarService
{
    ...
    private function bootstrapCommands(\Base\Core\Module $module)
    {
    ...
    private function bootstrapRoutes(\Base\Core\Module $module)
    {
    ...
    private function bootstrapConfigs(\Base\Core\Module $module)
    {
    ...
    private function bootstrapFactories(\Base\Core\Module $module)
    {
    ...
    private function bootstrapMigrations(\Base\Core\Module $module)
    {
    ...
    private function bootstrapSeeders(\Base\Core\Module $module)
    {
    ...
    private function bootstrapModels(\Base\Core\Module $module)
    {
    ...
    private function bootstrapProviders(\Base\Core\Module $module)
    {
    ...
    private function bootstrapEvents(\Base\Core\Module $module)
    {
