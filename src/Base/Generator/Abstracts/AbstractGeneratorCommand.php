...
abstract class AbstractGeneratorCommand extends Command
{
    ...
    {
        return Api::getModule($this->getModuleName());
    }
    ...
    final protected function defaultStubOptions(): array
    {
        return [
     ...
     * @return array
     */
    abstract protected function setArguments(): array;
     ...
     * @return array
     */
    abstract protected function setOptions(): array;
    ...
    {
        return $this->anticipate('For what module would you like to generate a ' . $this->getGeneratorName() . '.', Api::getModuleNames());
    }
