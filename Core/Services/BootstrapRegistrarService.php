...
use Core\Contracts\ConditionalAutoRegistration;
...
class BootstrapRegistrarService
{
    ...
    private function bootstrapCommands(\Core\Core\Module $module)
    {
    ...
    private function bootstrapRoutes(\Core\Core\Module $module)
    {
    ...
    private function bootstrapConfigs(\Core\Core\Module $module)
    {
    ...
    private function bootstrapFactories(\Core\Core\Module $module)
    {
    ...
    private function bootstrapMigrations(\Core\Core\Module $module)
    {
    ...
    private function bootstrapSeeders(\Core\Core\Module $module)
    {
    ...
    private function bootstrapModels(\Core\Core\Module $module)
    {
    ...
    private function bootstrapProviders(\Core\Core\Module $module)
    {
    ...
    private function bootstrapEvents(\Core\Core\Module $module)
    {
