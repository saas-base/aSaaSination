...
use Core\Console\SeedCommand;
use Core\Observers\CacheObserver;
use Core\Policies\OwnershipPolicy;
use Core\Services\BootstrapRegistrarService;
...
class BootstrapServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        /* Override the seed command with the base custom one */
